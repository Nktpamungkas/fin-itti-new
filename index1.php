...
<?php
    ...
    } else if (!isset($_SESSION['pasidFin'])) { ?>
        <script>
...
<head>
    ...
    <title>Finishing-ITTI | <?php if ($_GET['p'] != "") {
                                echo ucwords($_GET['p']);
                            } else {
                                echo "Home";
                            } ?></title>
...
<body class="hold-transition skin-blue sidebar-mini sidebar-collapse fixed">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <?php if ($_SESSION['deptFin'] == "FIN") {
                $Wdept = " ";
            } else {
                $Wdept = " AND dept='$_SESSION[deptFin]' ";
            } ?>
            <!-- Header Navbar -->
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <?php 
                            $qryNCP2 = mysqli_query($con1, "SELECT
                                                                    COUNT(*) AS jml
                                                                FROM
                                                                    tbl_ncp_qcf
                                                                WHERE
                                                                    NOT ISNULL(tgl_rencana) 
                                                                    $Wdept
                                                                    AND status = 'Belum OK'
                                                                    AND (
                                                                        penyelesaian = ''
                        ...
                        <li class="dropdown tasks-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <?php $qryNCP3 = mysqli_query($con1, "SELECT
                                                                                    no_ncp
                                                                                FROM
                                                                                    tbl_ncp_qcf
                                                                                WHERE
                        ...
                        <?php 
                            $qryNCP4 = mysqli_query($con1, "SELECT
                                                                        COUNT(*) AS jml
                                                                    FROM
                                                                        tbl_ncp_qcf
                                                                    WHERE
                        ...
                        <li class="dropdown tasks-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <!-- Inner menu: contains the tasks -->
                                    <ul class="menu">
                                        <?php $qryNCP5 = mysqli_query($con1, "SELECT
                                                                                    no_ncp
                                                                                FROM
                                                                                    tbl_ncp_qcf
                                                                                WHERE
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <?php if ($_SESSION['deptFin'] == "FIN" or $_SESSION['deptFin'] == "PPC") {  ?>
                        <li class="treeview <?php if ($_GET['p'] == "Schedule" or $_GET['p'] == "Status-Mesin" or $_GET['p'] == "Lap-Schedule" or $_GET['p'] == "Line-News") {
                                                echo "active";
                                            } ?>">
                            ...
                            <ul class="treeview-menu">
                                <li class="<?php if ($_GET['p'] == "Masuk") {
                                                echo "active";
                                            } ?>"><a href="Masuk"><i class="fa fa-calendar text-success"></i> <span>KK Masuk</span></a></li>
                                <li class="<?php if ($_GET['p'] == "Schedule") {
                                                echo "active";
                                            } ?>"><a href="Schedule"><i class="fa fa-calendar text-success"></i> <span>Schedule</span></a></li>
                                <!-- <li class="<?php if ($_GET['p'] == "Belah-Cuci") {
                                                echo "active";
                                            } ?>"><a href="BelahCuci"><i class="fa fa-television text-primary"></i> <span>Belah Cuci</span></a></li>
                                <li class="<?php if ($_GET['p'] == "Antrian-Kartu-Kerja") {
                                                echo "active";
                                            } ?>"><a href="AntrianKartuKerja"><i class="fa fa-television text-warning"></i> <span>Antrian Kartu Kerja</span></a></li>
                                <li class="<?php if ($_GET['p'] == "Susunan-Kartu-Kerja") {
                                                echo "active";
                                            } ?>"><a href="SusunanKartuKerja"><i class="fa fa-television text-danger"></i> <span>Susunan Kartu Kerja</span></a></li> -->
                                ...
                                <li class="<?php if ($_GET['p'] == "Lap-Schedule") {
                                                echo "active";
                                            } ?>"><a href="LapSchedule"><i class="fa fa-television text-danger"></i> <span>Lap Schedule</span></a></li>
                                <li class="<?php if ($_GET['p'] == "Line-News") {
                                                echo "active";
                                            } ?>"><a href="LineNews"><i class="fa fa-newspaper-o text-warning"></i> <span>Line News</span></a></li>
                                <li class="<?php if ($_GET['p'] == "Data-NOW") {
                                                echo "active";
                                            } ?>"><a href="DataNow"><i class="fa fa-newspaper-o text-primary"></i> <span>Data Now</span></a></li>
                            </ul>
                        </li>
