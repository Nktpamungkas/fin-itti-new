...
<head>
  ...
  <title>Finishing-ITTI | Log in</title>
...
<div class="login-box">
  ...
  <a href="index.php"><b>FIN</b> ITTI</a>  
...
if($_POST){ //login user
  ...
  $sql=mysqli_query($con,"SELECT * FROM user_login WHERE user='$username' AND password='$password' LIMIT 1");
  ...
  $_SESSION['mamberFin']=$r['mamber'];
  $_SESSION['fotoFin']=$r['foto'];
  $_SESSION['deptFin']=$r['dept'];
  $_SESSION['aksesFin']=$r['akses'];
  $_SESSION['nama1Fin']=$r['nama'];	  
  //login_validate();
