...
<table width="100%">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><strong><font size="+1" >SCHEDULE FINISHING</font></strong></td>
	</tr>
  </table>
...
LEFT JOIN tbl_mesin b ON a.no_mesin=b.no_mesin WHERE not a.`status`='selesai' GROUP BY a.no_mesin ORDER BY a.kapasitas DESC,a.no_mesin ASC"); */
	$data=mysqli_query($con,"SELECT b.* from tbl_no_mesin b ORDER BY b.no_mesin ASC");
	$no=1;
	$n=1;
	$c=0;
	 ?>
  ...
  while($rowd=mysqli_fetch_array($data)){
	  ...
	  $nomc=mysqli_real_escape_string($rowd['no_mesin']);
		 ?>
    <tr>
      <td rowspan="7"><div align="center" style="font-size: 18px;"><strong><?php echo $nomc;?></strong>
        </div><div align="center" style="font-size: 12px;">(<?php echo $rowd['jenis'];?>)</div>
      </td>	  	
      <td valign="top" style="height: 0.27in;"><div align="center">1</div></td>
	  <?php foreach(tampil($nomc,"1",$Awal,$Akhir) as $dd){ ?>	
    ...
    <tr>
      ...
      <?php foreach(tampil($nomc,"2",$Awal,$Akhir) as $dd1){ ?>	
    ...
    <tr>
      ...
      <?php foreach(tampil($nomc,"3",$Awal,$Akhir) as $dd2){ ?>	
    ...
    <tr>
      ...
      <?php foreach(tampil($nomc,"4",$Awal,$Akhir) as $dd3){ ?>	
    ...
    <tr>
      ...
      <?php foreach(tampil($nomc,"5",$Awal,$Akhir) as $dd4){ ?>	
    ...
    <tr>
      ...
      <?php foreach(tampil($nomc,"6",$Awal,$Akhir) as $dd5){ ?>	
    ...
    <tr>
      ...
      <?php foreach(tampil($nomc,"7",$Awal,$Akhir) as $dd6){ ?>	
