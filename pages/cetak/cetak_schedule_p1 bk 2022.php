...
<table width="100%">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><strong><font size="+1" >SCHEDULE FINISHING <?php echo strtoupper($NoMC); ?></font><br>FW-14-PPC-11/00</strong></td>
    </tr>
  </table>
<table width="100%" border="0">
	...
	if($Awal!=""){ $where2=" DATE_FORMAT(tgl_update,'%Y-%m-%d')='$Awal' "; }else{ $where2=" tampil='1'";}	  
...
ORDER BY
  ...
  while($rowd=mysqli_fetch_array($data)){
    ...
    <tr>
      ...
      <td valign="top"><span style="height: 0.35in;"><?php echo $rowd['proses'];?><br><?php if($rowcek>0){ echo"(Sudah Jalan<br>".$rCEks['tgl_buat']."<br>".$rCEks['no_mesin'].")";}?><br><?php echo $rowd['catatan'];?><br><?php echo $rowd['tgl_update']; ?></span></td>	  
    </tr>
