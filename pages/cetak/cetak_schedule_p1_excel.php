        ...
        <tr>
            <td>
                <table width="100%" border="1" class="table-list1">
                    ...
                    if ($Awal != "") {
                        $where2 = " DATE_FORMAT(tgl_update,'%Y-%m-%d')='$Awal' ";
                    } else {
                        $where2 = " `tampil`='1' ";
                    }
                    ...
                    while ($rowd = mysqli_fetch_array($data)) {
                        ...
                        $rCEks = mysqli_fetch_assoc($qCeks);
                        $rowcek = mysqli_num_rows($qCeks)
                    ?>
                        <?php if(empty($rCEks['tgl_buat'])) : ?>
                        <tr>
                            ...
                            <td valign="top"><span style="height: 0.35in;"><?php echo $rowd['proses']; ?><br><?php if ($rowcek > 0) {
                                                                                                                ...
                                                                                                                } ?><br><?php echo $rowd['catatan']; ?><br><?php echo $rowd['tgl_update']; ?></span></td>
                        </tr>
                        <?php endif; ?>
