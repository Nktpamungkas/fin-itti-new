							...
							<div class="box-body">
								...
								<div class="box-footer">
									...
									<?php if($_POST['awal'] && $_POST['akhir']) : ?>
										<div class="btn-group">
											<a href="pages/cetak/cetak_statusMesin_p1.php?awal=<?= $_POST['awal']; ?>&akhir=<?= $_POST['akhir']; ?>" class="btn btn-warning pull-left" target="_blank"><i class="fa fa-print"></i> Cetak</a>
											<a href="pages/cetak/cetak_statusMesin_p1_excel.php?awal=<?= $_POST['awal']; ?>&akhir=<?= $_POST['akhir']; ?>" class="btn btn-danger" target="_blank"><i class="fa fa-file-excel-o"></i> Cetak Ke Excel</a>
										</div>
									<?php endif; ?>
								</div>
							</div>
