...
TRIM(A.SUBCODE02) AS SUBCODE02, TRIM(A.SUBCODE03) AS SUBCODE03, TRIM(C.EXTERNALREFERENCE) AS EXTERNALREFERENCE, A.BASEPRIMARYQUANTITY AS QTY_NETTO, TRIM(A.BASEPRIMARYUOMCODE) AS BASEPRIMARYUOMCODE,
...
LEFT JOIN 
	...
	SALESORDERLINE.EXTERNALREFERENCE, SUM(SALESORDERLINE.BASEPRIMARYQUANTITY) AS QTY_ORDER,SUM(SALESORDERLINE.BASESECONDARYQUANTITY) AS QTY_PANJANG_ORDER, SALESORDERLINE.BASESECONDARYUOMCODE AS QTY_PANJANG_ORDER_UOM, SALESORDERDELIVERY.DELIVERYDATE FROM SALESORDER SALESORDER
...
<?php 
	if($_POST['save']=="save"){
	  ...
	  $qryCekN2=mysqli_query($con,"SELECT * from tbl_schedule WHERE nodemand='".$_POST['nodemand']."' and  proses='".$_POST['proses']."' and tampil='1'");
