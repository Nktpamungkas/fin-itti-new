<?php
$Cdye=mysql_connect("10.0.0.10","dit","4dm1n");
$dbdye=mysql_select_db("db_dying",$Cdye)or die("Gagal Koneksi");
$host1="10.0.0.4";
$username1="timdit";
$password1="4dm1n";
$db_name1="TM";
...
db_connect($db_name);
    $id=$_GET['id'];	
	$qcek=mysql_query("SELECT * FROM tbl_schedule WHERE id='$id'",$Cdye);
